...
void func_8002C218(u16 actor_index) {
    ...
    vel_x_scaled = gActors[actor_index].velocityX / 16384;
    vel_y_scaled = gActors[actor_index].velocityY / 16384;
    vel_scaled = sqrtf((vel_x_scaled * vel_x_scaled) + (vel_y_scaled * vel_y_scaled));
    if ((gActors[actor_index].velocityX == 0) && (gActors[actor_index].flags & 0x20)) {
        gActors[actor_index].unk_0C4 -= vel_scaled;
    }
    else if (gActors[actor_index].velocityX < 0) {
        gActors[actor_index].unk_0C4 += vel_scaled;
    }
    else {
        gActors[actor_index].unk_0C4 -= vel_scaled;
...
s32 func_8002C3C8(u16 actor_index) {
    if (gActors[actor_index].unk_098 & 0x200) {
        ...
        if (gActors[actor_index].unk_0D6 == 0) {
            gActors[actor_index].unk_150 |= 0x80000000;
        } else {
            gActors[actor_index].unk_150 &= 0x7FFFFFFF;
        }
        gActors[actor_index].unk_150 |= 0x100000;
        func_80029134(actor_index);
        return 1;
    }
    else if (gActors[actor_index].unk_098 & 2) {
        if (gActors[actor_index].unk_0DD != 0x13) {
            if (gActors[actor_index].unk_0DD != 0x17) {
                ...
                gActors[actor_index].velocityY = gActors[actor_index].unk_0FC;
                gActors[actor_index].velocityX = gActors[actor_index].unk_0F8;
                if (gActors[actor_index].unk_0FC < 0x20000) {
...
void func_8002C510(u16 actor_index) {
    if (gActors[actor_index].flags & 0x80) {
        func_8002ABE4(actor_index, gActors[actor_index].unk_158 + 6);
    }
    else {
        func_8002ABE4(actor_index, gActors[actor_index].unk_158 - 8);
    }
    func_8002AC30(actor_index, gActors[actor_index].unk_158);
}
...
void func_8002C5C4(u16 actor_index, u16 arg1, s16 arg2, f32 scale, s32 arg4, s16 arg5) {
    ...
    gActors[actor_index].flags = 0x11403;
    gActors[actor_index].unk_084 = arg1;
    if (scale != 1.0) {
        gActors[actor_index].unk_094 = 8;
        gActors[actor_index].unk_094 |= 0x1;
        gActors[actor_index].scaleX = scale;
        gActors[actor_index].scaleY = scale;
    }
    gActors[actor_index].unk_158 = arg2;
    func_8002C510(actor_index);
    if (arg4 != 0) {
        gActors[actor_index].unk_18C = arg4;
        gActors[actor_index].unk_094 |= 0x200;
    }
    gActors[actor_index].unk_15C = arg5;
...
void func_8002D040(u16 actor_index, s32 arg1) {
    ...
    gActors[actor_index].unk_0A6 = 8;
    gActors[actor_index].unk_0A8 = -8;
    gActors[actor_index].unk_0A2 = -8;
    gActors[actor_index].unk_0A4 = 8;
    gActors[actor_index].flags = 0x282;
    gActors[actor_index].unk_0E4 = 0x28; \
    gActors[actor_index].unk_0F8 = 0x11000; \
    gActors[actor_index].unk_0FC = 0x7C000;
    gActors[actor_index].unk_0DE = 0;
    gActors[actor_index].unk_0DF = 0;
    gActors[actor_index].unk_0DB = 0xB; \
    gActors[actor_index].unk_0DA = 0x84;
    gActors[actor_index].unk_110 = 8.0f;
    gActors[actor_index].velocityX = 0;
    gActors[actor_index].velocityY = 0;
    index = func_8003123C(D_800E1380, gActors[actor_index].posX.whole, gActors[actor_index].posY.whole, 0x11);
    if (index != 0) {
        gActors[index].unk_094 = 0x209;
        gActors[index].unk_18C = (s32) D_800D84E8;
        gActors[index].unk_084 = 0x168;
        gActors[index].unk_150 = 0x800000;
        gActors[index].unk_154 = -15;
        gActors[index].scaleX = 1.0f;
        gActors[index].scaleY = 1.0f;
        gActors[index].unk_110 = 0.25f;
    ...
    if (index != 0) {
        gActors[index].unk_094 = 1;
        gActors[index].unk_154 = 16;
