...
s32 func_8004F7D8(u16 actor_index) {
    ...
    var_a1 <<= 0x10;
    var_t0 <<= 0x10;
    if (temp_a3 >= func_8005C6D0((var_a1) - D_801373E0.unk_00)) {
        D_801373E0.unk_00 = var_a1;
    }
    else if (D_801373E0.unk_00 < var_a1) {
    ...
    if (temp_a3 >= func_8005C6D0(var_t0 - D_801373E0.unk_04)) {
        D_801373E0.unk_04 = var_t0;
    }
    else if (D_801373E0.unk_04 < var_t0) {
    ...
    var_a0 = D_801373E0.unk_00;
    var_a1 = D_801373E0.unk_04;
...
void func_800500B0(u16 actor_index) {
    ...
    if ((gActors[actor_index].unk_0A0 & 7) == 7) {
        ...
        // fakematch: ^0
        if ((var_a3 != (func_8005D338(actor_index)^0)) && !(gActors[actor_index].flags & 0x4040)) {
            func_8005D370(actor_index, var_a3);
        }
    }
    ...
    // fakematch: ^0
    if (var_a3 != (func_8005D338(actor_index)^0)) {
        if (gActors[actor_index].flags & 0x4040) {
            gActors[actor_index].velocityX.raw = Math_ApproachS32(gActors[actor_index].velocityX.raw, 0, func_80048C94(0));
            if (func_8005D418(actor_index) != 0) {
                gActors[actor_index].flags &= ~0x4040;
    ...
    if (actor_1 == 0xFFFF) {
        ...
        if (!(gActors[actor_0].unk_140_u16[1] & 7)) {
            ...
            if ((gActors[actor_0].hitboxBY1 + gActors[actor_0].posY.whole < gActors[actor_1].hitboxBY1 + gActors[actor_1].posY.whole) && 
                ...
                D_801373E4 = D_801373E0.unk_04 + 0xFFFF0000;
            }
            if ((gActors[actor_1].posY.whole + gActors[actor_1].hitboxBY0 < gActors[actor_0].posY.whole + gActors[actor_0].hitboxBY0) && 
                ...
                D_801373E4 = D_801373E0.unk_04 + 0x10000;
            }
        }
        temp = 0x20000;
        if (var_t1 != 0) {
            if (func_8005C6D0(D_801373E0.unk_00 - var_t1) < temp) {
                D_801373E0.unk_00 = var_t1;
                gActors[actor_0].flags &= 0xFF3CFFFF; \
                gActors[actor_0].flags |= 0x10000;
            }
            else if (D_801373E0.unk_00 < var_t1) {
                D_801373E0.unk_00 += temp;
            }
            else {
                D_801373E0.unk_00 -= temp;
            }
        ...
        if (var_t0 != 0) {
            if (func_8005C6D0(D_801373E0.unk_04 - var_t0) < 0x40000) {
                D_801373E0.unk_04 = var_t0;
                gActors[actor_0].flags &= 0xFF3CFFFF; \
                gActors[actor_0].flags |= 0x10000;
            }
            else if (D_801373E0.unk_04 < var_t0) {
                D_801373E4 = D_801373E0.unk_04 + temp;
            }
            else {
                D_801373E4 = D_801373E0.unk_04 - temp;
            }
        ...
        if (gActors[actor_0].flags_098 & 0xC) {
            gActors[actor_1].posX.raw = D_801373E0.unk_00 + gActors[actor_0].posX.raw;
            gActors[actor_1].flags_098 |= gActors[actor_0].flags_098 & 0xC;
        }
        var_t0 = D_801373E0.unk_04;
        ...
        if ((gActors[actor_0].flags_098 & 0x10) && 
            ...
            if (!(gActors[actor_0].flags_098 & 0x20) || (gActors[actor_0].posY.raw < (gActors[actor_1].posY.raw - D_801373E0.unk_04))) {
...
void func_80053B28(u16 arg0, u16 arg1) {
    s32 sp2C;
    s32 sp28;
    s32 step;

    func_80052C4C(arg0, arg1);
    sp2C = -((gActors[arg1].hitboxBX0 + gActors[arg1].hitboxBX1) / 2);
    ...
    sp2C <<= 0x10;
    sp28 = (gActors[arg0].hitboxBY1 - gActors[arg1].hitboxBY0) << 0x10;
    step = 0x40000;
    if (func_8005C6D0(D_801373E0.unk_00 - sp2C) < step) {
        D_801373E0.unk_00 = sp2C;
    }
    ...
    gActors[arg0].posX.raw = gActors[arg1].posX.raw - D_801373E0.unk_00;
    func_8002877C(arg0);
    if (gActors[arg0].flags_098 & 0xC) {
        // fakematch: is D_801373E0 array?
        gActors[arg1].posX.raw = gActors[arg0].posX.raw + (&D_801373E0)[0].unk_00;
        gActors[arg1].flags_098 |= gActors[arg0].flags_098 & 0xC;
    }
    // fakematch: is D_801373E0 array?
    sp28 = gActors[arg0].posY.raw + (&D_801373E0)[0].unk_04;
    if ((gActors[arg0].flags_098 & 0x10) && (sp28 < gActors[arg1].posY.raw)) {
        gActors[arg1].posY.raw = sp28;
        gActors[arg1].flags_098 |= gActors[arg0].flags_098 & 0x10;
    }
    else {
        gActors[arg0].posY.raw = gActors[arg1].posY.raw - D_801373E0.unk_04;
    }
    gActors[arg1].unk_104 = gActors[arg1].posX.raw;
    gActors[arg1].unk_108 = gActors[arg1].posY.raw;
    gActors[arg1].unk_10C = gActors[arg1].posZ.raw;
}
