...
u16 func_8004F614(u16 actor_index, s32 arg1, s32 arg2, s16 arg3) {
    ...
    gActors[actor_index].flags &= ~0x2000000;
    if (temp_s0 == 0xFFFF) {
        return temp_s0;
    }
...
void func_80052004(u16 actor_index) {
    ...
    if (func_800491B8(actor_index, 0, -0xE) != 0) {
        ...
        if ((gActors[actor_index].velocityY.raw > 0) && (gActors[actor_index].flags_098 & 0x4010)) {
...
void func_80052CD0(u16 actor_0, u16 actor_1) {
    ...
    if (actor_1 == 0xFFFF) {
        if (!(gActors[actor_0].flags & 0x810000)) {
            ...
            if (!(gActors[actor_0].flags_098 & flags_98_mask)) {
                if (gActors[actor_0].flags & 0x20) {
                    pos_x = -pos_x;
                }
...
void func_80055C2C(u16 actor_0, u16 actor_1) {
    ...
    case 1:
        ...
        if (func_8004F35C(actor_0, (u32* ) &gActors[actor_0].var_150) != 0) {
            ...
            gActors[actor_0].velocityX.raw *= gActors->unk_120;
            gActors[actor_0].velocityY.raw *= gActors->unk_120;
            Sound_PlaySfx(0x24);
